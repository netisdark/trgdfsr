module.exports = {
  ...
  langs: {
    en: {
      invalid_amount: "Put a big 🌝 number, my child riskin all ur money means more income  🌝🙌",
      not_enough_money: "wow if u have this balance then pigs will start Fallin from the sky🙈😂🍹 ",
